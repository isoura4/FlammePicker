...
};gdjs.StartPageCode.asyncCallback10231636 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.5), (runtimeScene) => (gdjs.StartPageCode.asyncCallback10231636(runtimeScene, asyncObjectsList)));
}
}
